...
\begin{longtable}{|p{3.5cm}|p{5cm}|p{3cm}|}
	...
	\textbf{DFTBinit\_charges} & use charges of former calculation as initial guess? (useful for calculations where energy or gradients are calculated several times for the same system, e.\,g. in MD simulations or in local optimisation)  & bool [true] \\
	\textbf{DFTBext\_charges} & name of a file with external charges (e.\,g. used for QM/MM)  & string [none] \\
\end{longtable} 
